...
-- Add SET search_path TO 'public' to the 3 identified functions for enhanced security

-- Fix 1: Update match_kb_chunks function
...
-- Fix 2: Update track_referral_signup function
...
-- Fix 3: Update upsert_blog_post function
...
BEGIN
  ...
  -- Log security event for blog content operations
  PERFORM log_security_event('blog_posts', 'BLOG_POST_UPSERTED', p_slug,
    NULL, jsonb_build_object('title', p_title, 'operation', 'upsert'));
END;
$function$;
