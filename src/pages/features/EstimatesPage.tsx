  ...
  return (
    ...
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-4 text-[#374151]">
              <p>
                Create detailed, professional estimates that win more projects. Our intelligent pricing engine helps you calculate accurate costs while maintaining healthy profit margins.
              </p>
              <p>
                Compare multiple estimate versions side-by-side to present options to clients. Track approval rates and optimize your pricing strategy over time.
              </p>
              <p>
                Convert approved estimates to invoices instantly, maintaining all line items and pricing details for seamless project billing.
              </p>
            </div>
          </div>
                ...
                <div className="space-y-3">
                  <div className="bg-white rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <h5 className="font-medium text-[#111827]">Basic Package</h5>
                      <span className="text-lg font-semibold text-[#111827]">$8,500</span>
                    </div>
                    <ul className="text-sm text-[#6B7280] space-y-1">
                      <li>• 12x16 pressure-treated deck</li>
                      <li>• Basic railing system</li>
                  ...
                  <div className="bg-white rounded-lg p-4 border-2 border-green-200">
                    <div className="flex justify-between items-center mb-2">
                      <h5 className="font-medium text-[#111827]">Premium Package</h5>
                      <span className="text-lg font-semibold text-[#111827]">$12,800</span>
                    </div>
                    <ul className="text-sm text-[#6B7280] space-y-1">
                      <li>• 12x16 composite decking</li>
                      <li>• Designer railing with glass panels</li>
                      <li>• LED lighting system</li>
                      <li>• Built-in bench seating</li>
                    </ul>
                    <div className="mt-3 flex justify-between items-center">
                      <span className="text-xs text-[#6B7280]">Sent yesterday</span>
      ...
      <section className="max-w-6xl mx-auto px-6">
        <h2 className="text-2xl font-semibent text-[#111827] mb-8 text-center">Integrations</h2>
