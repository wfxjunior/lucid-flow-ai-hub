  ...
  "inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        success: "bg-success text-primary-foreground hover:bg-success/90 shadow-[0_2px_8px_hsl(var(--fb-success)/0.3)] hover:shadow-[0_4px_16px_hsl(var(--fb-success)/0.4)] border-0",
        warning: "bg-warning text-primary-foreground hover:bg-warning/90 shadow-[0_2px_8px_hsl(var(--fb-warning)/0.3)] hover:shadow-[0_4px_16px_hsl(var(--fb-warning)/0.4)] border-0",
      },
      size: {
