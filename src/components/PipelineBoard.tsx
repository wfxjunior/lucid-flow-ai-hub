  ...
  return (
    <div className="space-y-4 md:space-y-6 p-2 md:p-0">
          ...
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg md:text-2xl font-bold">{leads.length}</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-lg md:text-2xl font-bold">{formatCurrency(leads.reduce((sum, lead) => sum + lead.value, 0))}</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-3 md:p-4">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs md:text-sm text-muted-foreground">Avg Cycle</p>
                <p className="text-lg md:text-2xl font-bold">21 days</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="overflow-x-auto">
        <div className="flex gap-2 md:gap-4 min-w-max pb-4">
          {stages.map((stage) => (
            <div
              key={stage.id}
              ...
              <Card className={`${stage.color} border-2 border-dashed border-gray-300 hover:border-gray-400 transition-colors`}>
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    <CardTitle className="text-base md:text-lg">{stage.name}</CardTitle>
