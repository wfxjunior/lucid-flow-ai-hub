    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-24 pb-16 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-4">
            <Button className="bg-[#111827] hover:bg-[#111827]/90 text-white px-6 py-3 rounded-lg font-medium">
              Start for free
            </Button>
            <Link
              to="/contact"
      ...
      <section className="py-16 bg-[#F8FAFC] border-t border-[#E5E7EB]">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <Button className="bg-[#111827] hover:bg-[#111827]/90 text-white px-8 py-3 rounded-lg font-medium">
