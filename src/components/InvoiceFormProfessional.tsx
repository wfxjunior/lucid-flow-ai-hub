...
interface InvoiceFormProfessionalProps {
  invoice?: any
  onSuccess?: () => void
  onClose?: () => void
}

export function InvoiceFormProfessional({ invoice, onSuccess, onClose }: InvoiceFormProfessionalProps) {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Professional invoice with enhanced design and features
          </p>
        </div>
        {onClose && (
          <button 
